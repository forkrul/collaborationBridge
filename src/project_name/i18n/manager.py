...
from .config import SupportedLocale, LOCALE_CONFIGS, DEFAULT_LOCALE, FALLBACK_LOCALE
...
class TranslationManager:
    ...
    def format_currency(self, amount: float, locale: str, currency: Optional[str] = None) -> str:
