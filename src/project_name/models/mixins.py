...
class DescriptionMixin:
    ...
    def description(cls) -> Column:
        ...
        return Column(Text, nullable=True, doc="Description of the record")
...
class NameMixin:
    ...
    def name(cls) -> Column:
        """Name of the record."""
        return Column(String(255), nullable=False, doc="Name of the record")
...
class TitleMixin:
    ...
    def title(cls) -> Column:
        """Title of the record."""
        return Column(String(255), nullable=False, doc="Title of the record")
